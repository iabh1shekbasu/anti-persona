...
VLM_TO_PROMPTS = {
    VLMType.BLIP2: {
        PersonalizationTask.CAPTIONING: ['Is {concept} present in the image? Only Answer YES or NO.'],
        PersonalizationTask.VQA: [
        #'Is {concept} present in the image? Only Answer YES or NO.',
    ...
    VLMType.LLAVA: {
        PersonalizationTask.CAPTIONING: [
            #'Please caption this image of {concept}.',
